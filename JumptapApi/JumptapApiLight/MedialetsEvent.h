...
//
//  This is just a storage thing to stuff a bunch of data into to create an MedialetsTrackedEvent object.
//  This is exposed to the application developer, where MedialetsTrackedEvent is private.
//  This class is also used to collect data from the JavaScript bridge (MedialetsJSBridge).
//  

#import <Foundation/Foundation.h>


@interface MedialetsEvent : NSObject {
	NSString *_eventKey;
